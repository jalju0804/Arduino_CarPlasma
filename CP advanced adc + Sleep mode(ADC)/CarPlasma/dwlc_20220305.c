...
void HandlePlasmaMode(void)
{
	...
	switch(sys_mode)
	{
		...
		/*case PLASMA_HI:
			...
			flag |= FLAG_PLASMA_bm;
			plasma_cnt	=	0;
			plasma_duty	=	N_PLASMA_HI_DUTY;
			plasma_period	=	N_PLASMA_HI_PERIOD;
			break;
		...
		case PLASMA_OFF:
			...
			flag |= FLAG_PLASMA_bm;
			plasma_cnt	=	0;
			plasma_duty	=	N_PLASMA_OFF_DUTY;
			plasma_period	=	N_PLASMA_OFF_PERIOD;
			break;
			*/
	}
